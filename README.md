...
$ curl -L https://github.com/anujdas/cryogen/releases/download/v1.2.0/cryogen-darwin-x64.tgz | tar xzC /usr/local/bin
...
$ curl -L https://github.com/anujdas/cryogen/releases/download/v1.2.0/cryogen-linux-x64.tgz | tar xzC /usr/local/bin
```
